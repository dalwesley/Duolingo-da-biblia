...
class DailyQuestDefs {
  static const List<DailyQuest> core = [
    ...
    DailyQuest(
      id: 'perfect',
            title: 'Cena sem erros',
            subtitle: 'Termine uma cena com 100%',
      target: 1,
      stepsReward: 40,
      icon: '🪔',
    ),
    ...
    DailyQuest(
      id: 'memory',
            title: 'Memorizar hoje',
            subtitle: 'Revise 3 versículos',
      target: 3,
      stepsReward: 25,
      icon: '🧠',
    ),
...
class WeeklyQuestDefs {
  static const List<DailyQuest> all = [
    ...
    DailyQuest(
      id: 'w_perfect',
            title: 'Duas cenas nítidas',
            subtitle: '2 cenas com 100% na semana',
      target: 2,
      stepsReward: 100,
      icon: '💎',
    ),
