...
- [ ] Onboarding → primeira missão em <2 min (deep-link pós-login)
- [ ] Pipeline semanal no admin: N missões publicadas sem release
...
- [ ] Novas mecânicas de liga/social
- [ ] Paridade com YouVersion
- [ ] Oração/meditação estilo Hallow
- [ ] Polimento cinematográfico sem missão nova
...
| Êxodo | 12 missões | aprofundar |
| Evangelhos | 12 missões densificadas | manter |
| Atos | 4 | → 10+ |
| Apocalipse | 4 | → 8+ |
